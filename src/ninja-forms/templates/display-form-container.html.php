...
?>
<div id="ninja-forms nf-form-<?php echo $form_id; ?>-cont" class="nf-form-cont<?php echo esc_attr( $wrapper_class ); ?>" aria-live="polite" aria-labelledby="nf-form-title-<?php echo $form_id ?>" aria-describedby="nf-form-errors-<?php echo $form_id; ?>" role="form">
