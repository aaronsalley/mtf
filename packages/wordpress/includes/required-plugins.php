...
add_action( 'tgmpa_register', function () {
	...
	$plugins = array(
		...
		array(
			...
			'source'             => dirname( __FILE__ ) . '/elementor-pro.zip', // The plugin source.
		...
		array(
			...
			'required'					=> true,
			'force_activation'	=> true,
			'source'             => dirname( __FILE__ ) . '/events-calendar-pro.6.0.0.zip', // The plugin source.
		...
		array(
			...
			'required'					=> true,
			'force_activation'	=> true,
			'source'             => dirname( __FILE__ ) . '/the-events-calendar-eventbrite-tickets.4.6.11.zip', // The plugin source.
			'external_url'       => 'https://theeventscalendar.com/', // If set, overrides default API URL and points to an external URL.
		),
		// WP GraphQL
		array(
