...
**_We strongly recommend the use of the [Custom TGMPA Generator](http://tgmpluginactivation.com/download/) if you intend to use TGMPA in a theme which is to be published via WordPress.org or Themeforest._**
...
**Note:** TGM Plugin Activation library authors are not responsible for the _end-user support_ for any plugin or theme which uses the library.
