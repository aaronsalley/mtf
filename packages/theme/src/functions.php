...
function mission_command_register_required_plugins() {
	...
	$config = array(
		...
		/*
		'strings'      => array(
			'page_title'                      => __( 'Install Required Plugins', 'mission_command' ),
			'menu_title'                      => __( 'Install Plugins', 'mission_command' ),
			/* translators: %s: plugin name. * /
			'installing'                      => __( 'Installing Plugin: %s', 'mission_command' ),
			/* translators: %s: plugin name. * /
			'updating'                        => __( 'Updating Plugin: %s', 'mission_command' ),
			'oops'                            => __( 'Something went wrong with the plugin API.', 'mission_command' ),
			...
			'return'                          => __( 'Return to Required Plugins Installer', 'mission_command' ),
			'plugin_activated'                => __( 'Plugin activated successfully.', 'mission_command' ),
			'activated_successfully'          => __( 'The following plugin was activated successfully:', 'mission_command' ),
			/* translators: 1: plugin name. * /
			'plugin_already_active'           => __( 'No action taken. Plugin %1$s was already active.', 'mission_command' ),
			/* translators: 1: plugin name. * /
			'plugin_needs_higher_version'     => __( 'Plugin not activated. A higher version of %s is needed for this theme. Please update the plugin.', 'mission_command' ),
			/* translators: 1: dashboard link. * /
			'complete'                        => __( 'All plugins installed and activated successfully. %1$s', 'mission_command' ),
			'dismiss'                         => __( 'Dismiss this notice', 'mission_command' ),
			'notice_cannot_install_activate'  => __( 'There are one or more required or recommended plugins to install, update or activate.', 'mission_command' ),
			'contact_admin'                   => __( 'Please contact the administrator of this site for help.', 'mission_command' ),
